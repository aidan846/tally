...
assert.equal(formatAnswer('£11.16'), '<span class="answer-unit">£</span><span class="answer-number">11.16</span>');
assert.equal(formatAnswer('$-4.25'), '<span class="answer-unit">$</span><span class="answer-number">-4.25</span>');
assert.equal(formatAnswer('A$20.00'), '<span class="answer-unit">A$</span><span class="answer-number">20.00</span>');
